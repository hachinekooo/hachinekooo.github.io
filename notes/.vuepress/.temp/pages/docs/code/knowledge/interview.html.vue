<template><div><h2 id="spring" tabindex="-1"><a class="header-anchor" href="#spring"><span>Spring</span></a></h2>
<h3 id="说说循环依赖" tabindex="-1"><a class="header-anchor" href="#说说循环依赖"><span>说说循环依赖</span></a></h3>
<ul>
...
<h4 id="具体是咋解决的" tabindex="-1"><a class="header-anchor" href="#具体是咋解决的"><span>具体是咋解决的</span></a></h4>
<ol>
...
<h3 id="为什么要三级缓存-二级不行吗" tabindex="-1"><a class="header-anchor" href="#为什么要三级缓存-二级不行吗"><span>为什么要三级缓存，⼆级不⾏吗</span></a></h3>
...
<h4 id="构造方法注入出现了循环依赖怎么解决" tabindex="-1"><a class="header-anchor" href="#构造方法注入出现了循环依赖怎么解决"><span>构造方法注入出现了循环依赖怎么解决</span></a></h4>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="常见的注解" tabindex="-1"><a class="header-anchor" href="#常见的注解"><span>常见的注解</span></a></h2>
<h3 id="spring-中" tabindex="-1"><a class="header-anchor" href="#spring-中"><span>Spring 中</span></a></h3>
<blockquote>
...
<h3 id="springboot" tabindex="-1"><a class="header-anchor" href="#springboot"><span>SpringBoot</span></a></h3>
<blockquote>
<p>主要是自动配置相关</p>
</blockquote>
<table>
...
<h2 id="抽象类-abstract-class-和接又-interface-有什么区别" tabindex="-1"><a class="header-anchor" href="#抽象类-abstract-class-和接又-interface-有什么区别"><span>抽象类(abstract class)和接⼜(interface)有什么区别</span></a></h2>
<p>相同点：1、两者都不能实例化；2、可以拥有抽象方法。<br>
区别：<br>
1、抽象类定义的关键字是<code v-pre>abstract class</code>，接口定义的关键字是 <code v-pre>interface</code>；
...
6、抽象方法在业务编程上更像一个模板，有自己的功能，同时也可以有优化补充的多种形式，而接口更像是一种规范和要求，实现就要按照要求来进行。</p>
<h2 id="静态方法和实例方法有何不同" tabindex="-1"><a class="header-anchor" href="#静态方法和实例方法有何不同"><span>静态⽅法和实例⽅法有何不同</span></a></h2>
<ul>
<li>
