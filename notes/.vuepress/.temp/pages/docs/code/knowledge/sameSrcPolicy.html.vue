...
<h2 id="触发" tabindex="-1"><a class="header-anchor" href="#触发"><span>触发</span></a></h2>
...
<h3 id="配置配置类" tabindex="-1"><a class="header-anchor" href="#配置配置类"><span>配置配置类</span></a></h3>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="crossorigin-注解" tabindex="-1"><a class="header-anchor" href="#crossorigin-注解"><span>CrossOrigin 注解</span></a></h3>
<h5 id="作用-1" tabindex="-1"><a class="header-anchor" href="#作用-1"><span>作用：</span></a></h5>
<p>在 controller 上添加@CrossOrigin 注解用来开启跨域请求，让其他域的请求可以访问该 controller。</p>
<h5 id="详解" tabindex="-1"><a class="header-anchor" href="#详解"><span>详解：</span></a></h5>
<p>origin属性：允许可访问的域列表</p>
<p>maxAge：准备响应前的缓存持续的最大时间（以秒为单位）</p>
<h4 id="使用位置" tabindex="-1"><a class="header-anchor" href="#使用位置"><span>使用位置</span></a></h4>
<ul>
<li>类</li>
<li>方法</li>
</ul>
