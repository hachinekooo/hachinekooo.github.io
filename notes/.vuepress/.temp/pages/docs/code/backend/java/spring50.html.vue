...
<Mermaid id="mermaid-384" code="eJxLL0osyFDwCeLietox++nuXQq6unYKT/bNfbF12rPNK562LuVC5oBln3bMfbq8+2nPNKAWKAsi3r/++ZQVXBAKLPJySsOz9Y1cAGvhNUI="></Mermaid><p>创建前后的增强</p>
<ul>
...
<p>@ComponentScan, @Bean, @Mapper 等注解的解析属于核心容器（即 BeanFactory）的扩展功能
2. 这些扩展功能由不同的 BeanFactory 后处理器来完成，其实主要就是补充了一些 bean 定义</p>
...
<Mermaid id="mermaid-1060" code="eJxLL0osyFDwCeLiSjXUSFV42jH76e5dmlypRkBOcWqJwrPNK562LlVI0+TiSjPUSIMrACrX1bVLAxGpRlxcAMg6GWw="></Mermaid><p>解决</p>
<ul>
<li>仍然使用 @Lazy 生成代理</li>
<li>代理对象虽然还是同一个，但当每次<strong>使用代理对象的任意方法</strong>时，由代理创建新的 f 对象</li>
</ul>
<Mermaid id="mermaid-1076" code="eJxLL0osyFDwCeLiSjXUSFV42jH76e5dmlypRkBOcWqJwrPNK562LlVIe7J78fMJbZpcXGmGGmlwZWlGyBxjJA7QOF1du1QjoEm6uk/27n8+ZUXas2k7n22eChROM8QujEO1MRcXALSiSpg="></Mermaid><div class="language-java line-numbers-mode" data-highlighter="shiki" data-ext="java" data-title="java" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">@</span><span style="--shiki-light:#A626A4;--shiki-dark:#E5C07B">Component</span></span>
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">public</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD"> class</span><span style="--shiki-light:#C18401;--shiki-dark:#E5C07B"> E</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> {</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">    @</span><span style="--shiki-light:#A626A4;--shiki-dark:#E5C07B">Autowired</span></span>
...
<Mermaid id="mermaid-1572" code="eJxLzkksLnbJTEwvSszl4gLzFBxTyjKTU6Ec39SSjPwUz7yS1KLk1IKS/CIkRcVwXkB+Zl5JcmkJTJQLJqBgU6Orq+BYXJCaXOLlWlFQlFpcnJmfB5PmgtgFUYVpFdQ4iDS6HWh8hXygGqUnOxqU4CrxKIH6kcvGBqgitSgtMTnVzg4miiqI6SxUebhtmGaBnIldMUwWAAImitk="></Mermaid><p>代理相关类图</p>
<ul>
...
<Mermaid id="mermaid-2316" code=""></Mermaid><ul>
...
<Mermaid id="mermaid-2352" code="eJxLzkksLnbJTEwvSszl4gooyi9ILSqpdE3JLMkvCkpNzywuKapUyNfVVVB6umSWkgKqAi4uG5vMvJLUorTE5FQ7OzRZmHa8irgAPOUwBA=="></Mermaid><ul>
...
<Mermaid id="mermaid-2373" code="eJx9j8EKwjAQRO/5iv5A/6AIahW8iQqel3QsC2lSN2uh4MdbFQ+taa8zb3ZmraMYS6ZaqDGXvsU2+A6ikKx45nl25qZ1GBkpbAPyV6G2hRyGQAopWWB1z3DV2lrEGJKXzpDOQU+4PxC1JKUN+2poNYkpWZ6vspFSwqEmhZksWiATwxbouX0LkfGbP/kT+KqRg3/fZYsF9ihheEb7XcUa5ISao0pvTFGwH9gbWawmEybef9vYn2l4AZSAyUs="></Mermaid><ul>
...
<Mermaid id="mermaid-2654" code=""></Mermaid><h4 id="图3" tabindex="-1"><a class="header-anchor" href="#图3"><span>图3</span></a></h4>
<Mermaid id="mermaid-2658" code=""></Mermaid><h3 id="_26-controlleradvice-之-modelattribute" tabindex="-1"><a class="header-anchor" href="#_26-controlleradvice-之-modelattribute"><span>26) @ControllerAdvice 之 @ModelAttribute</span></a></h3>
...
<figure><img src="@source/appends/img/image-20211021160145072.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>接下来勾选 Spring Web 支持</p>
<figure><img src="@source/appends/img/image-20211021162416525.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>步骤2：编写控制器</p>
