<template><div><h2 id="业务" tabindex="-1"><a class="header-anchor" href="#业务"><span>业务</span></a></h2>
<h3 id="添加订单" tabindex="-1"><a class="header-anchor" href="#添加订单"><span>添加订单</span></a></h3>
<figure><img src="@source/appends/img/pengchengBookMs_addOrder.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="一些坑" tabindex="-1"><a class="header-anchor" href="#一些坑"><span>一些坑</span></a></h3>
<ul>
<li>拼写错误
<ul>
...
<h2 id="知识点" tabindex="-1"><a class="header-anchor" href="#知识点"><span>知识点</span></a></h2>
<h3 id="日期的处理" tabindex="-1"><a class="header-anchor" href="#日期的处理"><span>日期的处理</span></a></h3>
<ul>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数据库和封装类对应" tabindex="-1"><a class="header-anchor" href="#数据库和封装类对应"><span>数据库和封装类对应</span></a></h3>
<p>数据库中使用 bigInt 在 java 中使用 Long 类型进行对应。</p>
<h3 id="resp-数据格式化" tabindex="-1"><a class="header-anchor" href="#resp-数据格式化"><span>resp 数据格式化</span></a></h3>
<ul>
<li>格式化数组中的对象</li>
</ul>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查询结果的封装" tabindex="-1"><a class="header-anchor" href="#查询结果的封装"><span>查询结果的封装</span></a></h3>
<h4 id="单行单列" tabindex="-1"><a class="header-anchor" href="#单行单列"><span>单行单列</span></a></h4>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h4 id="多行多列" tabindex="-1"><a class="header-anchor" href="#多行多列"><span>多行多列</span></a></h4>
<h5 id="使用视图类" tabindex="-1"><a class="header-anchor" href="#使用视图类"><span>使用视图类</span></a></h5>
<blockquote>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h5 id="使用-list-和-map" tabindex="-1"><a class="header-anchor" href="#使用-list-和-map"><span>使用 List 和 Map</span></a></h5>
<blockquote>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="记住账户" tabindex="-1"><a class="header-anchor" href="#记住账户"><span>记住账户</span></a></h3>
<blockquote>
...
<h5 id="token" tabindex="-1"><a class="header-anchor" href="#token"><span>token</span></a></h5>
<blockquote>
...
<h4 id="session" tabindex="-1"><a class="header-anchor" href="#session"><span>session</span></a></h4>
<blockquote>
<p>使用 session 可以实现对用户身份的验证，当服务器端设置好 session 之后，我们不用在写什么特殊的验证机制就可以实现在单次回话中对用户身份的验证。所以不适用于来实现记住账户功能。</p>
</blockquote>
<h5 id="项目中的实现" tabindex="-1"><a class="header-anchor" href="#项目中的实现"><span>项目中的实现</span></a></h5>
<p>关键代码：</p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#E06C75">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="调试开发技巧" tabindex="-1"><a class="header-anchor" href="#调试开发技巧"><span>调试开发技巧</span></a></h2>
<h3 id="通过检查功能测试自己的选择器是否正确" tabindex="-1"><a class="header-anchor" href="#通过检查功能测试自己的选择器是否正确"><span>通过检查功能测试自己的选择器是否正确</span></a></h3>
<ul>
<li>打开检查功能</li>
<li>点击选中元素选项卡</li>
...
<p>举例：
<img src="@source/appends/img/UseCheckToCheckSelector.png" alt="" loading="lazy"></p>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">  });  </span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">}</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="善用搜索快速定位" tabindex="-1"><a class="header-anchor" href="#善用搜索快速定位"><span>善用搜索快速定位</span></a></h3>
...
<h4 id="检查浏览器元素选选项卡" tabindex="-1"><a class="header-anchor" href="#检查浏览器元素选选项卡"><span>检查浏览器元素选选项卡</span></a></h4>
<h4 id="检查浏览器网络选项卡" tabindex="-1"><a class="header-anchor" href="#检查浏览器网络选项卡"><span>检查浏览器网络选项卡</span></a></h4>
<h5 id="查看载荷" tabindex="-1"><a class="header-anchor" href="#查看载荷"><span>查看载荷</span></a></h5>
<h5 id="查看预览" tabindex="-1"><a class="header-anchor" href="#查看预览"><span>查看预览</span></a></h5>
<h5 id="查看响应" tabindex="-1"><a class="header-anchor" href="#查看响应"><span>查看响应</span></a></h5>
<blockquote>
<p>查看前端返回的 <code v-pre>JSON</code> 数据是由有问题，若 <code v-pre>JSON</code> 数据没有问题那么可能是在数据渲染到页面的过程中出现了问题。</p>
</blockquote>
<h4 id="查看状态码" tabindex="-1"><a class="header-anchor" href="#查看状态码"><span>查看状态码</span></a></h4>
<h5 id="_200" tabindex="-1"><a class="header-anchor" href="#_200"><span>200</span></a></h5>
<blockquote>
<p>200 了但是没有达到预期，可能是请求的问题。例如参数不全、请求路径等。</p>
</blockquote>
<h5 id="_404" tabindex="-1"><a class="header-anchor" href="#_404"><span>404</span></a></h5>
<blockquote>
<p>可能是请求地址写错了。</p>
</blockquote>
<h5 id="_500" tabindex="-1"><a class="header-anchor" href="#_500"><span>500</span></a></h5>
<blockquote>
<p>服务器端代码错误，这时打端点进行调试。一般可能是参数接收处理问题。</p>
</blockquote>
<h2 id="开发" tabindex="-1"><a class="header-anchor" href="#开发"><span>开发</span></a></h2>
<p>Service 调用 DAO，并且处理一下问题，提供服务。</p>
<h3 id="管理员管理" tabindex="-1"><a class="header-anchor" href="#管理员管理"><span>管理员管理</span></a></h3>
<h4 id="管理员表" tabindex="-1"><a class="header-anchor" href="#管理员表"><span>管理员表</span></a></h4>
<table>
<thead>
<tr>
<th>字段</th>
...
<h4 id="admindao-接口" tabindex="-1"><a class="header-anchor" href="#admindao-接口"><span>AdminDao 接口</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<h3 id="分类管理" tabindex="-1"><a class="header-anchor" href="#分类管理"><span>分类管理</span></a></h3>
<h4 id="分类表" tabindex="-1"><a class="header-anchor" href="#分类表"><span>分类表</span></a></h4>
<table>
<thead>
<tr>
<th>字段</th>
...
<h4 id="sortdao-接口" tabindex="-1"><a class="header-anchor" href="#sortdao-接口"><span>SortDao 接口</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<h3 id="图书管理" tabindex="-1"><a class="header-anchor" href="#图书管理"><span>图书管理</span></a></h3>
<h4 id="图书表" tabindex="-1"><a class="header-anchor" href="#图书表"><span>图书表</span></a></h4>
<table>
<thead>
<tr>
<th>字段</th>
...
<h4 id="bookdao-接口" tabindex="-1"><a class="header-anchor" href="#bookdao-接口"><span>BookDao 接口</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<td>void</td>
<td>selectByPage</td>
<td>PageBookVo page, String bname, String bauthor, String bscope</td>
<td></td>
</tr>
<tr>
<td>查询图书总条目数</td>
...
<h3 id="受众管理" tabindex="-1"><a class="header-anchor" href="#受众管理"><span>受众管理</span></a></h3>
<h4 id="受众表" tabindex="-1"><a class="header-anchor" href="#受众表"><span>受众表</span></a></h4>
<table>
<thead>
<tr>
<th>字段</th>
...
<h4 id="scopedao" tabindex="-1"><a class="header-anchor" href="#scopedao"><span>ScopeDao</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<h3 id="顾客管理" tabindex="-1"><a class="header-anchor" href="#顾客管理"><span>顾客管理</span></a></h3>
<h4 id="顾客表" tabindex="-1"><a class="header-anchor" href="#顾客表"><span>顾客表</span></a></h4>
<table>
<thead>
<tr>
<th>字段</th>
...
<h4 id="customerdao" tabindex="-1"><a class="header-anchor" href="#customerdao"><span>CustomerDao</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<h3 id="订单管理" tabindex="-1"><a class="header-anchor" href="#订单管理"><span>订单管理</span></a></h3>
<h4 id="订单表" tabindex="-1"><a class="header-anchor" href="#订单表"><span>订单表</span></a></h4>
<table>
<thead>
<tr>
<th>字段</th>
...
<h4 id="customerbookdao" tabindex="-1"><a class="header-anchor" href="#customerbookdao"><span>CustomerBookDao</span></a></h4>
<table>
<thead>
<tr>
<th>方法</th>
