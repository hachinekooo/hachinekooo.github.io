<template><div><h1 id="覆盖索引" tabindex="-1"><a class="header-anchor" href="#覆盖索引"><span>覆盖索引</span></a></h1>
<blockquote>
<p>查询的列要被所建的索引覆盖到</p>
</blockquote>
<p>为了避免回表查询，导致的不必要的性能损耗。</p>
<p>在业务场景中，如果存在多个查询条件，考虑针对于查询字段建立索引时，建议建立联合索引，而非单列索引。</p>
<h1 id="索引设计原则" tabindex="-1"><a class="header-anchor" href="#索引设计原则"><span>索引设计原则</span></a></h1>
<ul>
<li>
...
<h1 id="索引失效的情况" tabindex="-1"><a class="header-anchor" href="#索引失效的情况"><span>索引失效的情况</span></a></h1>
<ul>
