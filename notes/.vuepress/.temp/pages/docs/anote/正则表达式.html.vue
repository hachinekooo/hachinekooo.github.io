<template><div><ol>
<li>
<p>任意一个字符表示匹配任意对应的字符，如 <code v-pre>a</code> 匹配 <code v-pre>a</code>，<code v-pre>7</code>匹配<code v-pre>7</code>，<code v-pre>-</code>匹配<code v-pre>-</code>。</p>
</li>
<li>
<p><code v-pre>[]</code>代表匹配中括号中其中任一个字符，如<code v-pre>[abc]</code>匹配 <code v-pre>a</code> 或 <code v-pre>b</code> 或 <code v-pre>c</code>。</p>
</li>
<li>
<p><code v-pre>-</code>在中括号里面和外面代表含义不同，如在外时，就匹配<code v-pre>-</code>，如果在中括号内<code v-pre>[a-b]</code>表示匹配26个小写字母中的任一个；<code v-pre>[a-zA-Z]</code>匹配大小写共52个字母中任一个；<code v-pre>[0-9]</code>匹配十个数字中任一个。</p>
</li>
<li>
<p><code v-pre>^</code> 在中括号里面和外面含义不同，如在外时，就表示开头，如 <code v-pre>^7[0-9]</code> 表示匹配开头是7的，且第二位是任一数字的字符串；如果在中括号里面，表示除了这个字符之外的任意字符(包括数字，特殊字符)，如 <code v-pre>[^abc]</code> 表示匹配除去 abc 之外的其他任一字符。</p>
</li>
<li>
<p><code v-pre>.</code>表示匹配<font color="#de7802">任意的字符</font>。</p>
</li>
<li>
<p><code v-pre>\d</code> 表示<font color="#de7802">数字</font>。</p>
</li>
<li>
<p><code v-pre>\D</code> 表示<font color="#de7802">非数字</font>。</p>
</li>
</ol>
<p>8. <code v-pre>\s</code> 表示由<font color="#de7802">空字符</font>组成，<code v-pre>[\t\n\r\x\f]</code>。</p>
<p>9. <code v-pre>\S</code> 表示由非空字符组成，<code v-pre>[^\s]</code>。</p>
<p>10. <code v-pre>\w</code> 表示<font color="#de7802">字母</font>、<font color="#de7802">数字</font>、<font color="#de7802">下划线</font>，<code v-pre>[a-zA-Z0-9_]</code>。</p>
<p>11. <code v-pre>\W</code>表示<font color="#de7802">不是</font>由字母、数字、下划线组成。</p>
<p>12. <code v-pre>?</code> 表示出现<font color="#de7802">0次</font>或<font color="#de7802">1次</font>。</p>
<p>13. <code v-pre>+</code>表示出现<font color="#de7802">1次</font>或<font color="#de7802">多次</font>。</p>
<p>14. <code v-pre>*</code>表示出现<font color="#de7802">0次</font>、<font color="#de7802">1次</font>或<font color="#de7802">多次</font>。</p>
<p>15. <code v-pre>{n}</code>表示出现<font color="#de7802">n次</font>。</p>
<p>16. <code v-pre>{n,m}</code>表示出现<font color="#de7802">n~m次</font>。</p>
<p>17. <code v-pre>{n,}</code>表示出现<font color="#de7802">n次或n次以上</font>。</p>
<p>18. <code v-pre>XY</code>表示X后面跟着Y，这里X和Y分别是正则表达式的一部分。</p>
<p>19. <code v-pre>X|Y</code>表示X或Y，比如&quot;food|f&quot;匹配的是foo（d或f），而&quot;(food)|f&quot;匹配的是food或f。</p>
<p>20. <code v-pre>(X)</code>子表达式，将X看做是<font color="#de7802">一个整体</font></p>
<h1 id="在-javascript-中使用" tabindex="-1"><a class="header-anchor" href="#在-javascript-中使用"><span>在 JavaScript 中使用</span></a></h1>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="在-java-中使用" tabindex="-1"><a class="header-anchor" href="#在-java-中使用"><span>在 Java 中使用</span></a></h1>
<p>在 java 中使用需要两个反斜杠来表示一个反斜杠</p>
